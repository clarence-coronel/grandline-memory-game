<template>
    <div class="w-full p-2 md:p-3 bg-black/60 shadow-black flex justify-center items-center sticky left-0 top-0 z-50">
        <div class="w-full max-w-[1600px] flex flex-col md:flex-row justify-center items-center md:justify-between gap-5 md:gap-12">
            ...
            <div class="flex gap-10">
                <div class="flex gap-2 items-center">
                    ...
                    <span class="font-bold text-lg md:text-2xl text-white">{{ gameStore.getBerries }}</span>
                </div>
                <div class="flex gap-2 items-center">
