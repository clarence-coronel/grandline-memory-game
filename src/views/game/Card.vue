<template>
    <button @click="selectCard" class="focus:outline-none outline-none flex justify-center p-3 items-center md:hover:-translate-y-3 duration-200 w-full max-w-64 aspect-[5/7] rounded-lg bg-secondary">
